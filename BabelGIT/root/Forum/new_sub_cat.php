<?php 
require('../config.php');
if ($_SESSION['admin'] != 1 || !isset($_GET['block_id'])) {
...
if (isset($_POST['submit'])){
    ...
    if (empty($errors)) {
        if ($forum->add_sub_block($_GET['block_id'], $_POST['title'])) {
            header('Location: ' . DIR_FORUM);
        }
    }
}
...
?>
        <div class="page-content">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title">Sous-atégorie <small>Créez une sous-catégorie</small></h3>
                    <ul class="page-breadcrumb breadcrumb">
                        <?php 
                        $pagetitle = "Nouvelle sous-catégorie";
                        include(INC_BDCB);
                        ?>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="new_post" action="" method="post">
                        <h3>Votre nouvelle sous-catégorie</h3>
                        <?php
